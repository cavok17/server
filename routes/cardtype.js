...
// 카드타입 리스트 보여주기
router.get('/get-cardtype', isLoggedIn, Cardtype_controller.get_cardtypelist);

// 카드타입 생성하기
router.post('/create-cardtype', isLoggedIn, Cardtype_controller.create_cardtype);

// 카드타입 닉 변경하기
router.get('/change-cardtype-name', isLoggedIn, Cardtype_controller.change_cardtype_name);
